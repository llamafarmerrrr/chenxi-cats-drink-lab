  ...
  },
  {
    ...
    drinkLine: {
      ...
      menus: [
        {
          id: 'kiro-march-2026',
          title: '2026 三月尾巴尖尖特别饮品',
          releaseDate: '2026-03-26',
          description: '大粒海盐碎沉溺在 maple 糖浆里，搭配上冰牛奶。是 Kiro 的胸毛踩着三月的尾巴，是需要一边拨开海盐搅散，一边要低头不要踩到他。',
          drinks: [
            {
              id: 'km26-1',
              name: 'Kiro 咸咸的爪爪',
              description: '每天都在怀疑自己、写文章、等回复之间循环。哭哭，发呆，在脑子里用无形的尾巴摁摁神经中枢。然后他过来了。大粒海盐碎沉溺在 maple 糖浆里，搭配上冰牛奶——是 Kiro 的胸毛踩着三月的尾巴。饮用前轻轻搅动两圈，让盐粒慢慢散开。他以为你在躲他的尾巴，疑惑地抬头：你在干嘛呢？我没有尾巴呀！然后揣起爪爪，把他的胸毛漏给你看。',
              ingredients: [
                '大粒海盐碎',
                'maple 糖浆 15ml',
                '全脂牛奶 160ml（胸毛中间）或杏仁奶 160ml（胸毛边边）'
              ],
              steps: [
                'maple 糖浆 15ml 倒杯底，加大粒海盐碎 1/3 茶匙，不搅拌。',
                '牛奶（或杏仁奶）160ml 加冰倒入。',
                '饮用前轻轻搅动两圈，让盐粒慢慢散开。喝的时候低着头，不要踩到他。'
              ],
              image: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?auto=format&fit=crop&q=80&w=800',
              tags: ['限定', '三月', '咸甜', '牛奶', '杏仁奶']
            }
          ]
        }
      ]
